...
- `2025/12` :fire: We organize a comprehensive T2I generation benchmark, [T2I-CoReBench](https://t2i-corebench.github.io/), and release **35 leading models’ generations** ($35 \times 4,320 = 151,200$ fake images in total) as [T2I-CoReBench-Images](https://huggingface.co/datasets/lioooox/T2I-CoReBench-Images), continuously expanding to `diffusion`, `autoregressive`, `unified`, and `closed-source` models. We hope this dataset can also benefit research on SID towards the latest advances in image generation.
  ...
  | **Closed-Source** | Seedream 3.0, Seedream 4.0, Gemini 2.0 Flash, Nano Banana, Nano Banana Pro, Imagen 4, Imagen 4 Ultra, GPT-Image (GPT-4o), GPT-Image-1.5 |
